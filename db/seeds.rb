...
Senator.destroy_all
Senator.create(bioguide_Id:"M001", first_name:"Jerk", last_name:"Face", state: "CA", party: "R", node_type: "senator")
Senator.create(bioguide_Id:"M002", first_name:"What", last_name:"UP", state: "CA", party: "D", node_type: "senator")
